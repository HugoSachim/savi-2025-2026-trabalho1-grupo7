...
import numpy as np
import argparse
from Parte06.Ex1.auxiliary_functions_1 import changeImageColor, objectiveFunction
...
def main():
    ...
    mosaic_image[q_mask] = t_image[q_mask] + q_image[q_mask]
